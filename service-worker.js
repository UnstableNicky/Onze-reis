...
const CACHE='onze-dansreis-v6-1';
const CORE=['./','./index.html','./base.css','./pwa.css','./course.js','./cloud.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png','./gift-splash.webp'];
